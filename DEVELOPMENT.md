...
```bash
git remote add encore encore://renovation-task-manager-bnki
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/renovation-task-manager-bnki/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/renovation-task-manager-bnki/settings/integrations/github)
